...
public class InfoModify extends JFrame implements ActionListener{
   ...
   public InfoModify(MemberDTO memberDTO) {
      ...
      tel1C.setSelectedItem(memberDTO.getPhonenumber());
      email1T.setText(memberDTO.getEmail());
   ...
   public void actionPerformed(ActionEvent e) {
      if(modifyB == e.getSource()) {
         ...
         if(result == JOptionPane.YES_OPTION) {
            ...
            memberDTO.setPhonenumber((String)tel1C.getSelectedItem());
            memberDTO.setEmail(email1T.getText());
