...
public class Seat12 extends JButton implements Runnable {
	...
	public Seat12() {
		...
		name = new JLabel("[12��] �� �¼�",SwingConstants.CENTER);
	...
	public void run(){
		while(true){
			...
			else if(dao.getOnOff(12)==1) {
				this.setBackground(new Color(72,121,57));
				name.setFont(normalF);
				String text1 ="[12]��   "+dao.getName(12)+" ��";
				String text2 ="�ܿ��ð�  :  "+(dao.getTime(12)/60)+" �ð�"
						+(dao.getTime(12)%60)+"  ��";
				name.setText(text1);
