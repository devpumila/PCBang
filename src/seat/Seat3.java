...
public class Seat3 extends JButton implements Runnable {
	...
	public Seat3() {
		...
		name = new JLabel("[3��] �� �¼�",SwingConstants.CENTER);
	...
	public void run(){
		while(true){
			...
			else if(dao.getOnOff(3)==1) {
				this.setBackground(new Color(72,121,57));
				name.setFont(normalF);
				String text1 ="[3]��   "+dao.getName(3)+" ��";
				String text2 ="�ܿ��ð�  :  "+(dao.getTime(3)/60)+" �ð�"
						+(dao.getTime(3)%60)+"  ��";
				name.setText(text1);
