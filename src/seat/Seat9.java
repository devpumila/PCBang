...
public class Seat9 extends JButton implements Runnable {
	...
	public Seat9() {
		...
		name = new JLabel("[9��] �� �¼�",SwingConstants.CENTER);
	...
	public void run(){
		while(true){
			...
			else if(dao.getOnOff(9)==1) {
				this.setBackground(new Color(72,121,57));
				name.setFont(normalF);
				String text1 ="[9]��   "+dao.getName(9)+" ��";
				String text2 ="�ܿ��ð�  :  "+(dao.getTime(9)/60)+" �ð�"
						+(dao.getTime(9)%60)+"  ��";
				name.setText(text1);
