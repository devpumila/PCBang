...
public class Seat5 extends JButton implements Runnable {
	...
	public Seat5() {
		...
		name = new JLabel("[5��] �� �¼�",SwingConstants.CENTER);
	...
	public void run(){
		while(true){
			...
			else if(dao.getOnOff(5)==1) {
				this.setBackground(new Color(72,121,57));
				name.setFont(normalF);
				String text1 ="[5]��   "+dao.getName(5)+" ��";
				String text2 ="�ܿ��ð�  :  "+(dao.getTime(5)/60)+" �ð�"
						+(dao.getTime(5)%60)+"  ��";
				name.setText(text1);
