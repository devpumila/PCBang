...
public class Seat6 extends JButton implements Runnable {
	...
	public Seat6() {
		...
		name = new JLabel("[6��] �� �¼�",SwingConstants.CENTER);
	...
	public void run(){
		while(true){
			...
			else if(dao.getOnOff(6)==1) {
				this.setBackground(new Color(72,121,57));
				name.setFont(normalF);
				String text1 ="[6]��   "+dao.getName(6)+" ��";
				String text2 ="�ܿ��ð�  :  "+(dao.getTime(6)/60)+" �ð�"
						+(dao.getTime(6)%60)+"  ��";
				name.setText(text1);
